...
# 训练超参数
def train_with_hypers(name, hypers, early_stopping_patience):
    # print("当前超参数: ", hypers)
...
def find_best_hypers(name):
        ...
        for lengthscale in lengthscale_range:
            for noise in noise_range:
                ...
                try:
                    ...
                    score = train_with_hypers(name, hypers, early_stopping_patience=50)
    ...
    print(f"best_hypers_dict:{name}保存完成！")
...
# datasets_name = ['scan', 'pbe', 'hse','gllb-sc']
# random_seed_list = [42*i for i in range(1,11)]
# datasets_name = ['scan', 'pbe','gllb-sc', 'hse']
datasets_name = ['scan','gllb-sc', 'hse', 'pbe']

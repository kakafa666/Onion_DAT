...
# 返回的structures已经是pymatgen类型的结构了
...
def get_sampled_low_fidelity_dataset(name):
...
# 加载scan数据集的所有数据，因为scan数据集数据太少，无法采样，也之能训练一次
...
# 最小值： 0.0
# 平均值： 1.9226013
# scan数据集按带隙范围分层抽样后大小：472 随机种子：42
# 前10条抽样目标值：(tensor(1.5711), tensor(1.6001), tensor(1.4602), tensor(2.2667), tensor(0.6041), tensor(1.4859), tensor(0.8326), tensor(2.5321), te, tensor(2.2663))
# hse数据集大小：6030
# 最大值： 20.265214920043945
# 最小值： 0.0
# 平均值： 1.7556192376315332
# hse数据集按带隙范围分层抽样后大小：472 随机种子：42
# 前10条抽样目标值：(tensor(0), tensor(2.5918), tensor(2.2395), tensor(2.6081), tensor(1.8157), tensor(0), tensor(0), tensor(0), tensor(0), tensor(1.3441))
# hse数据集按带隙范围分层抽样后大小：472 随机种子：84
# 前10条抽样目标值：(tensor(3.6036), tensor(0), tensor(0), tensor(0), tensor(0), tensor(2.1221), tensor(0), tensor(0.8489), tensor(0.7592), tensor(1.2927))
# gllb-sc数据集大小：2290
# 最大值： 16.0
# 最小值： 0.106
# 平均值： 4.15374
# gllb-sc数据集按带隙范围分层抽样后大小：472 随机种子：42
# 前10条抽样目标值：(tensor(5.8400), tensor(4.6100), tensor(6.5700), tensor(5.4200), tensor(4.7600), tensor(7.1900), tensor(7.1900), tensor(4.7500), te700), tensor(5.9000))
# exp实验数据
# 最大值： 11.7
# 最小值： 0.0
# 平均值： 1.1965506
# 验证集索引集合: [   2    7    9 ... 2700 2701 2702] 验证集索引长度：1351
# 测试集索引集合: [   0    1    3 ... 2697 2698 2699] 测试集索引长度：1352
# 验证集大小：1351
# 测试集大小：1352